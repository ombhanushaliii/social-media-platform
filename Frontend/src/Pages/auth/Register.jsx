  ...
  <div className="w-full md:w-1/2 bg-black flex items-center justify-center px-6 py-8 overflow-hidden">
    <div className="w-80 h-full flex flex-col justify-center">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="button"
          className="w-80 flex items-center justify-center gap-2 border border-neutral-700 bg-neutral-800 text-white py-2.5 rounded-lg font-semibold hover:bg-neutral-700 transition duration-200"
        >
          <img
